...
class SaleReportInherit(models.Model):
    ...
    tax_total = fields.Float('Taxed Total', readonly=True)
    ...
    def _select(self):
        select_str = """
                   SELECT
                       ...
                       sum(l.price_total - l.price_subtotal / COALESCE(po.currency_rate, 1.0))::decimal(16,2) * currency_table.rate as tax_total,
